...
{
    QHotkeyHook::getInstance().endThread();
...
//    QRect screenRect = desktopWidget.screenGeometry(pt);
    QRect screenRect = QGuiApplication::screenAt(pt)->geometry();
...
//    KeyboardHook::getInstance().addHotkey(ENABLE_BLACKLIST, Hotkey(Settings::getHotkeyBlacklist()));
    ...
    QHotkeyHook::getInstance().addHotkey(CAPTURE_BOX, Settings::getHotkeyCaptureBox());
    QHotkeyHook::getInstance().addHotkey(RE_CAPTURE_LAST, Settings::getHotkeyReCaptureLast());
    QHotkeyHook::getInstance().addHotkey(TEXTLINE_CAPTURE, Settings::getHotkeyTextLineCapture());
    QHotkeyHook::getInstance().addHotkey(FORWARD_TEXTLINE_CAPTURE, Settings::getHotkeyForwardTextLineCapture());
    QHotkeyHook::getInstance().addHotkey(BUBBLE_CAPTURE, Settings::getHotkeyBubbleCapture());
    QHotkeyHook::getInstance().addHotkey(LANG_1, Settings::getHotkeyLang1());
    QHotkeyHook::getInstance().addHotkey(LANG_2, Settings::getHotkeyLang2());
    QHotkeyHook::getInstance().addHotkey(LANG_3, Settings::getHotkeyLang3());
    QHotkeyHook::getInstance().addHotkey(TEXT_ORIENTATION, Settings::getHotkeyTextOrientation());
    QHotkeyHook::getInstance().addHotkey(ENABLE_WHITELIST, Settings::getHotkeyWhitelist());
    QHotkeyHook::getInstance().addHotkey(ENABLE_BLACKLIST, Settings::getHotkeyBlacklist());
}
