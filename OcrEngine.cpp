...
//#ifdef Q_OS_WIN
    QString exeDirpath = QCoreApplication::applicationDirPath() + QDir::separator() + "tessdata";
//#endif

//#ifdef Q_OS_MACOS
//    QString exeDirpath = QDir("/usr/local/Cellar/tesseract/4.0.0/share/tessdata").dirName();
//#endif
