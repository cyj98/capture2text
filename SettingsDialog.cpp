...
//    ui->widgetHotkeyBlacklist->setHotkey(Hotkey(Settings::getHotkeyBlacklist()));
    ...
    ui->widgetHotkeyCaptureBox->setHotkey(Settings::getHotkeyCaptureBox());
    ui->widgetHotkeyRecaptureLast->setHotkey(Settings::getHotkeyReCaptureLast());
    ui->widgetHotkeyTextLineCapture->setHotkey(Settings::getHotkeyTextLineCapture());
    ui->widgetHotkeyForwardTextLineCapture->setHotkey(Settings::getHotkeyForwardTextLineCapture());
    ui->widgetHotkeyBubbleCapture->setHotkey(Settings::getHotkeyBubbleCapture());
    ui->widgetHotkeyLang1->setHotkey(Settings::getHotkeyLang1());
    ui->widgetHotkeyLang2->setHotkey(Settings::getHotkeyLang2());
    ui->widgetHotkeyLang3->setHotkey(Settings::getHotkeyLang3());
    ui->widgetHotkeyTextOrientation->setHotkey(Settings::getHotkeyTextOrientation());
    ui->widgetHotkeyWhitelist->setHotkey(Settings::getHotkeyWhitelist());
    ui->widgetHotkeyBlacklist->setHotkey(Settings::getHotkeyBlacklist());
...
//    Settings::setHotkeyBlacklist(ui->widgetHotkeyBlacklist->getHotkey().toStr());
    ...
    Settings::setHotkeyCaptureBox(ui->widgetHotkeyCaptureBox->getHotkey().toString());
    Settings::setHotkeyReCaptureLast(ui->widgetHotkeyRecaptureLast->getHotkey().toString());
    Settings::setHotkeyTextLineCapture(ui->widgetHotkeyTextLineCapture->getHotkey().toString());
    Settings::setHotkeyForwardTextLineCapture(ui->widgetHotkeyForwardTextLineCapture->getHotkey().toString());
    Settings::setHotkeyBubbleCapture(ui->widgetHotkeyBubbleCapture->getHotkey().toString());
    Settings::setHotkeyLang1(ui->widgetHotkeyLang1->getHotkey().toString());
    Settings::setHotkeyLang2(ui->widgetHotkeyLang2->getHotkey().toString());
    Settings::setHotkeyLang3(ui->widgetHotkeyLang3->getHotkey().toString());
    Settings::setHotkeyTextOrientation(ui->widgetHotkeyTextOrientation->getHotkey().toString());
    Settings::setHotkeyWhitelist(ui->widgetHotkeyWhitelist->getHotkey().toString());
    Settings::setHotkeyBlacklist(ui->widgetHotkeyBlacklist->getHotkey().toString());
...
//    ui->widgetHotkeyBlacklist->setHotkey(Hotkey(Settings::defaultHotkeyBlacklist));
    ui->widgetHotkeyCaptureBox->setHotkey(Settings::defaultHotkeyCaptureBox);
    ui->widgetHotkeyRecaptureLast->setHotkey(Settings::defaultHotkeyReCaptureLast);
    ui->widgetHotkeyTextLineCapture->setHotkey(Settings::defaultHotkeyTextLineCapture);
    ui->widgetHotkeyForwardTextLineCapture->setHotkey(Settings::defaultHotkeyForwardTextLineCapture);
    ui->widgetHotkeyBubbleCapture->setHotkey(Settings::defaultHotkeyBubbleCapture);
    ui->widgetHotkeyLang1->setHotkey(Settings::defaultHotkeyLang1);
    ui->widgetHotkeyLang2->setHotkey(Settings::defaultHotkeyLang2);
    ui->widgetHotkeyLang3->setHotkey(Settings::defaultHotkeyLang3);
    ui->widgetHotkeyTextOrientation->setHotkey(Settings::defaultHotkeyTextOrientation);
    ui->widgetHotkeyWhitelist->setHotkey(Settings::defaultHotkeyWhitelist);
    ui->widgetHotkeyBlacklist->setHotkey(Settings::defaultHotkeyBlacklist);
}
