...
const QString Settings::defaultHotkeyCaptureBox("Alt+Q");
const QString Settings::defaultHotkeyReCaptureLast("Alt+R");
const QString Settings::defaultHotkeyTextLineCapture("Alt+E");
const QString Settings::defaultHotkeyForwardTextLineCapture("Alt+W");
const QString Settings::defaultHotkeyBubbleCapture("Alt+S");
const QString Settings::defaultHotkeyLang1("Alt+1");
const QString Settings::defaultHotkeyLang2("Alt+2");
const QString Settings::defaultHotkeyLang3("Alt+3");
const QString Settings::defaultHotkeyTextOrientation("Alt+O");
const QString Settings::defaultHotkeyWhitelist("Alt+[");
const QString Settings::defaultHotkeyBlacklist("Alt+]");
